...
public class SpecServiceImpl implements SpecService {
    ...
    /**
     * 根据前端传过来的分类id->通过temple_id查询规格集合
     * @param categoryId
     * @return
     */
    @Override
    public List<Spec> findByCategory(Integer categoryId) {
        ...
        //知道分类id   temlate_id
        Category category = categoryMapper.selectByPrimaryKey(categoryId);//selectByPrimaryKey当前的主键id
        //根据分类id查询规格集合   temlate_id
        Spec spec = new Spec();//创建一个规格对象
        spec.setTemplateId(category.getTemplateId());//通过规格对象查询getTemplateId
