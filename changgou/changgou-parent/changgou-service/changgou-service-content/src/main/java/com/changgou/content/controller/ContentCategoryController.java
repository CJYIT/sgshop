...
public class ContentCategoryController {
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  ContentCategory contentCategory,@PathVariable(name = "id") Long id){
        //设置主键值
     ...
     */
    @GetMapping("/{id}")
    public Result<ContentCategory> findById(@PathVariable(name = "id") Long id){
